...
class ControlScreenRenderTest {
    ...
    fun renderOptimizedControlScreenToPng() {
        ...
        composeRule.runOnIdle { darkTheme = false }
        composeRule.onNodeWithTag("m2_reverse").performScrollTo().assertIsDisplayed().assertIsEnabled()
        saveRoot("control-screen-dual-motor.png")
        ...
        composeRule.waitForIdle()
        composeRule.onNodeWithTag("m2_reverse").performScrollTo().assertIsDisplayed()
