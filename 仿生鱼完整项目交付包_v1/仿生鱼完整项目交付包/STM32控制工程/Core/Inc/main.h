...
/* TB6612：M1 直流减速电机接 A 桥，M2(N20) 直流减速电机接 B 桥。 */
...
/* TB6612 待机/使能脚（PB5）。**可选**：仅当 CFG_MOTOR_STBY_PIN_ENABLED=1 时才由
 * 固件驱动。历史版本把 STBY 直接硬接 3.3 V，代码里没有任何控制；2026-09-23 台架
 * 排查「电机不转」时把它做成可选 GPIO，便于用软件确认使能电平是否真的到位。
 * 若硬件仍把 STBY 硬接高，保持该开关为 0 即可，PB5 不会被占用。 */
#define TB6612_STBY_Pin       GPIO_PIN_5
