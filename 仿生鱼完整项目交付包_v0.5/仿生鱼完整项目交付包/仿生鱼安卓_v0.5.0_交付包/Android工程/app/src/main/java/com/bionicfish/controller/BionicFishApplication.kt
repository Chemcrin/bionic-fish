...
import com.bionicfish.controller.transport.AndroidWifiTcpConnector
...
class BionicFishApplication : Application(), DefaultLifecycleObserver {
    ...
    override fun onCreate() {
        ...
        repository = DefaultBionicFishRepository(
            ...
            transportFactory = DefaultTransportFactory(capabilityProvider, tcpConnector = AndroidWifiTcpConnector(this)),
