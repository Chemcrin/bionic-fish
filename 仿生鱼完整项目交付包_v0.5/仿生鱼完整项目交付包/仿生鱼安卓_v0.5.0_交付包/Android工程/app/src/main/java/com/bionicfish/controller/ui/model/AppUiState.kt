...
data class ControlUiState(
    ...
    val motor2: MoveDirection = MoveDirection.STOP,
    val turn: TurnDirection = TurnDirection.CENTER,
    /** 仅为旧协议兼容值；双直流电机固件不以此调速。 */
    val stepSpeedRpm: Int = 60,
    val servoAngleDegrees: Int = 0,
    val reverseSupported: Boolean = true,
    /** 保留旧状态映射兼容性；双直流电机控制不再依赖该门禁。 */
...
data class TelemetryUiState(
    ...
    val actualStepRpm: Double? = null,
    val stepRunning: Boolean? = null,
    val motor1Direction: MoveDirection? = null,
    val motor2Direction: MoveDirection? = null,
    val servoAngleDegrees: Int = 0,
...
data class SettingsUiState(
    ...
    val apPort: String = ApDirectDefaults.PORT.toString(),
    val wifiHost: String = "",
    val wifiPort: String = "",
...
data class UiActions(
    ...
    val onMotor2Changed: (MoveDirection) -> Unit = {},
    ...
    val onApSsidChanged: (String) -> Unit = {},
    val onApHostChanged: (String) -> Unit = {},
    val onApPortChanged: (String) -> Unit = {},
    ...
    val onAllowReverseCommandChanged: (Boolean) -> Unit = {},
