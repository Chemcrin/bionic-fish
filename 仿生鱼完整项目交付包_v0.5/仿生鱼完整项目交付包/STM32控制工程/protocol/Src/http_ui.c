...
static const char kPage[] =
    ...
    "<div class=r><button id=A1>前进</button><button id=A0 class=no>停止</button>"
    "<button id=AR>后退</button></div>"
    "<div class=lb>电机 2（N20 唧筒 · 沉浮）</div>"
    "<div class=r><button id=B1>推（下潜）</button><button id=B0 class=no>停止</button>"
    "<button id=BR>拉（上浮）</button></div>"
